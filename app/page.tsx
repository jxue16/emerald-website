    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-grid { display: grid; grid-template-columns: 1fr 1fr; min-height: calc(100vh - 57px); }
        .ticker-wrap { overflow: hidden; background: #0f3d28; padding: 14px 0 14px; cursor: pointer; }
      ...
      <div style={{ fontFamily: "'DM Sans', sans-serif", backgroundColor: "#f7f5ef", color: "#1a1a18", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
        ...
        <section className="hero-grid" style={{ flex: 1 }}>
          ...
          {/* LEFT */}
          <div style={{ backgroundColor: "#1a1a18", padding: "80px 56px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          {/* RIGHT — stats */}
          <div style={{ backgroundColor: "#1a6e4a", padding: "80px 56px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            {[
